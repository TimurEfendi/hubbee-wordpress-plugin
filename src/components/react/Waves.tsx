/**
 * Waves - Canvas 2D Waves Background Component
 * Simplified version for WordPress (no Tailwind classes)
 */
...
export default function Waves({
  ...
  return (
    <div
      ref={containerRef}
      className="bz-cf-waves"
      style={{ backgroundColor }}
    >
      <canvas ref={canvasRef} className="bz-cf-waves__canvas" />
    </div>
  );
}
