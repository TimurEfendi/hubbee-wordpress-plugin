 ...
 * Copied from SaaS for WordPress React bundle
 */
...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line prefer-const -- program is reassigned after geometry setup
  ...
  return <div ref={ctnDom} className="bz-cf-aurora" />;
}
