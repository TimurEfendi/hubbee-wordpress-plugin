 ...
 * Original: src/content/Backgrounds/LightRays/LightRays.jsx
 *
 * Kept 1:1 with the original, only typed for TypeScript.
 * CSS inlined via style prop.
 */
...
void main() {
  ...
  return <div ref={containerRef} className={`light-rays-container ${className}`.trim()} style={{
    width: '100%', height: '100%', position: 'relative', pointerEvents: 'none', zIndex: 3, overflow: 'hidden'
  }} />;
};
