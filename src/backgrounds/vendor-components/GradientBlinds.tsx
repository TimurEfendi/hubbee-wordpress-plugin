/**
 * GradientBlinds Background Effect
 * Source: https://github.com/DavidHDev/react-bits (MIT License)
 * Original: src/content/Backgrounds/GradientBlinds/GradientBlinds.jsx
 *
...
`;
  ...
  return <div ref={containerRef} className={className} style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', ...(mixBlendMode && { mixBlendMode: mixBlendMode as any }) }} />;
};
