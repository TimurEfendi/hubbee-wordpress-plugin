 ...
 * Original: src/content/Backgrounds/Threads/Threads.jsx
 *
...
const Threads = (props: ThreadsProps) => {
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uDistance: { value: initial.distance ?? 0 },
    ...
    function update(t: number) {
      ...
      program.uniforms.uDistance.value = live.distance ?? 0;
  ...
  const { color: _c, amplitude: _a, distance: _d, enableMouseInteraction: _emi, ...rest } = props;
  void _c; void _a; void _d; void _emi;
