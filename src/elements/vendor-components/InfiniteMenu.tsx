...
class InfiniteGridMenu {
  ...
  #init(onInit: ((sk: InfiniteGridMenu) => void) | null): void {
...
const InfiniteMenu = ({ items = [], scale = 1.0, buttonColor = '#5227ff' }: InfiniteMenuProps) => {
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      {activeItem && (
        <>
          ...
          <div onClick={handleButtonClick} className={`action-button ${isMoving ? 'inactive' : 'active'}`} style={{ background: buttonColor }}>
            <svg className="action-button-icon" viewBox="0 0 24 24" width="26" height="26" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
